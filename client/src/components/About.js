...
const About = () => {
    return (
        <div>
            ...
            <div className ="photo" >
                <img src = {require("../images/Mayowa-Cofounder.jpg")} style={{height:500}}/>
            </div>
            ...
            <div >
                <img class = "picture" src = {require("../images/Ebony Cofounder.jpg")} height ={700} width={700} style={{align: 'auto'}} />
            </div>
